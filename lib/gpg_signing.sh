...
echo ""
echo -e "${GREEN}No new terminal needed.${NC} The signed test commit above proves signing"
echo "works in the current shell, and your global git config takes effect"
echo "immediately. The line appended to your shell rc (export GPG_TTY=…) is"
echo "only used by future shells — it doesn't need to be picked up here."
echo ""
